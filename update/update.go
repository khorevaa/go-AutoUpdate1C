...
func (о *Обновление) ВыполнитьОбновление() (e error) {
	...
	ЛогОбновления := logrus.WithFields(logrus.Fields{"СтрокаПодключения": о.СтрокаПодключения, "Пользователь": о.Пользователь})


	ЛогОбновления.Infof("Выполняю обновление информационной базы")
	...
	if e != nil {
		ЛогОбновления.WithError(e).Warning("Ошибка выполнения обновления")
	}

	//logrus.WithError(e).Warning("Ошибка выполнения обновления")
...
func (о *Обновление) выполнитьЗагрузкуКонфигурации() (e error) {
	...
	logrus.Infof(">> Загрузка конфигурации в информационную базу")
	...
	logrus.Infof(">> Обновление конфигурации в информационной базе")
